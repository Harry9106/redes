...
EtherFrame_Base::EtherFrame_Base(const char *name, short kind) : ::omnetpp::cMessage(name,kind)
{
    for (unsigned int i=0; i<1514; i++)
        this->data[i] = 0;
}

EtherFrame_Base::EtherFrame_Base(const EtherFrame_Base& other) : ::omnetpp::cMessage(other)
{
    copy(other);
}
...
void EtherFrame_Base::parsimPack(omnetpp::cCommBuffer *b) const
{
    ::omnetpp::cMessage::parsimPack(b);
    doParsimArrayPacking(b,this->data,1514);
}

void EtherFrame_Base::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::omnetpp::cMessage::parsimUnpack(b);
    doParsimArrayUnpacking(b,this->data,1514);
}
...
{
    if (k>=1514) throw omnetpp::cRuntimeError("Array of size 1514 indexed by %lu", (unsigned long)k);
    return this->data[k];
}
...
EtherFrameDescriptor::EtherFrameDescriptor() : omnetpp::cClassDescriptor("EtherFrame", "omnetpp::cMessage")
{
...
{
    return dynamic_cast<EtherFrame_Base *>(obj)!=nullptr;
}
